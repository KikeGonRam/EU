...
class IMCAppHorizontal:
    ...
    def create_left_panel(self):
        ...
        tk.Label(self.left_frame, text="Calculadora de IMC", 
                ...
                fg=self.colors['dark']).pack(pady=(0, 20))
...
• IMC ≥ 30: Obesidad"""
        ...
        tk.Label(info_frame, text=info_text, font=("Segoe UI", 10), 
                bg=self.colors['light'], fg="#64748b", justify=tk.LEFT).pack(anchor=tk.W)
